...
public class MMAX2 extends javax.swing.JFrame implements KeyListener ,java.awt.event.ComponentListener , java.awt.event.ActionListener
{
    ...
    private final HashSet switchHash = new HashSet();
    ...
    private final ButtonGroup autoSaveEveryMenuButtongroup = new ButtonGroup();
    ...
    public void executeHotSpot(String hotSpotString)
    {
        ...
        if (hotSpotString.startsWith("playwavsound"))
        {
            ...
            offset = (long)(start*16000*2);
            currentToken = toki.nextToken();
            end = Double.parseDouble(currentToken);
            temp = (long) (end*16000*2);
            length = temp-offset;
    ...
    private final void loadMMAXFile(String fileName)
    {
        ...
        if (verbose) {
			System.err.print("Loading Discourse ... ");
		}
        ...
        if (verbose) {
			System.err.println("Current working directory set to "+currentWorkingDirectory);
		}

        if (verbose) {
			System.err.println("done in "+(System.currentTimeMillis()-temp)+" milliseconds");
		}
        ...
        if (verbose) {
			System.err.print("Applying stylesheet "+currentDiscourse.getCurrentStyleSheet()+" ... ");
		}
        ...
        if (verbose) {
			System.err.print("Creating Markable mappings ... ");
		}
        temp = System.currentTimeMillis();
        ...
        currentTextPane.setStyledDocument(currentDocument);
        initializing = false;
    ...
    public final void requestSetLineSpacing(String spacing)
    {
        ...
        StyleConstants.setLineSpacing(result, val);
    ...
    private final void requestAboutWindow()
    {
        ...
        message = message + "Copyright 2003-2010 Dr. Mark-Christoph M�ller.\n";
    ...
    public final void executeBatchPlugins(ArrayList namesToBeExecuted)
    {
        ...
        for (int b=0;b<namesToBeExecuted.size();b++)
        {
            ...
            {
                JMenuItem item = pluginMenu.getItem(n);
